     ...
     */
        ...
        switch($_GET["event"])
        {
            default:
                ...
                $imageQuery = mysql_query("SELECT name, description, path, status FROM argus_images WHERE image_id='".$_GET["image"]."' AND account_id = '".$_COOKIE["argus"]."'") or die(mysql_error());
